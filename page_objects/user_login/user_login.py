...
from test_data.test_data import LoginCredentials, ProjectLoginCredentials
...
class ValidLoginForProject:
    def __init__(self, driver):
        self.driver = driver
        self.wait = WebDriverWait(self.driver, 20)

    def valid_user_email(self):
        self.wait.until(EC.presence_of_element_located(app.login_email_id)).send_keys(datap.valid_email)

    def valid_user_password(self):
        self.wait.until(EC.presence_of_element_located(app.login_password_id)).send_keys(datap.valid_password)
